...
const FROST = { dewPointLineC: 2.0 /* design assumption, stated on the card */,
  ...
  /* Benguet frost season. Marasigan (2017): January has the highest frequency of occurrences at every
     ...
     and farmers now expect episodes "until March". Marasigan et al. (2025) [MARASIGAN2025] analyse
     November to March.
...
const DEWPOINT_SETS = [
  ...
  { id: 'buck96', b: 18.678, c: 257.14, d: 234.5, ref: 'BUCK1996', name: 'Buck (1996)' }
];
...
const REFS = {
  ...
  DOMINGO2018: { cls: 'extension', cite: 'Domingo, O.F. (2018). Alternative crop shelter design increases yields of high value crops in the highlands. DOST-PCAARRD S&T Media Services, 17 April 2018. Reports a double-cladding shade-net shelter developed at Benguet State University under a project led by J.F. Malamug; lettuce, broccoli and strawberry yields increased. A news article, not a research paper.', url: 'https://www.pcaarrd.dost.gov.ph/index.php/quick-information-dispatch-qid-articles/alternative-crop-shelter-design-increases-yields-of-high-value-crops-in-the-highlands' },
  RAO1998: { cls: 'primary', cite: 'Rao, P.S., Gillespie, T.J., Schaafsma, A.W. (1998). Estimating wetness duration on maize ears from meteorological observations. Canadian Journal of Soil Science 78: 149-154. Compares six wetness models; the dew point depression model uses two criteria, 1.8 C for onset of wetting and 2.2 C for drying, fitted to maize ears in Ontario.', url: 'https://doi.org/10.4141/S97-012' },
  ...
  BASQUIAL2021: { cls: 'primary', cite: 'Basquial, D.A., De Guzman, C.C., Aspuria, E.T., Sta Cruz, P.C., Cuevas, V.C. (2021). Protected Cultivation Improves Growth of Lollo Rossa Lettuce Under Chilling Conditions in Benguet, Philippines. J. ISSAAS 27(2):154-165.', url: 'http://issaasphil.org/wp-content/uploads/2021/12/12.-Basquial-et-al-2021-Lettuce-protected-cultivation-FINAL.pdf' },
  MARASIGAN2017: { cls: 'primary', cite: 'Marasigan, R.A.A. (2017). Characterization of Frost Events in Benguet, Philippines. M.S. Meteorology thesis, Institute of Environmental Science and Meteorology, University of the Philippines Diliman. 70% of MODIS-detected frost occurrences at land-surface temperature at or below 10 °C. On terrain: "the elevation and morning potential insolation (MPI) are among the physiographic variables that influence the frost risk". DOI 10.13140/RG.2.2.24517.10727.', url: 'https://doi.org/10.13140/RG.2.2.24517.10727' },
  MARASIGAN2025: { cls: 'extension', cite: 'Marasigan, R.A.A., Padua, R.B., Quitos, C.J.S., Arca, M.K.R.J., Masallo, J.A., Esperanza, H.G., Eugenio, N.R., Basconcillo, J.Q. (2025). Frost Susceptibility Mapping in Benguet, Philippines. Proceedings of the Philippine Meteorological Society 8:42, ISSN 2599-5537; abstract of a paper presented at the 2025 PMS Annual Convention, 17 to 18 March 2025. Frost occurrences from MODIS nighttime land surface temperature (Aqua and Terra, November to March, 2005 to 2024) set against slope, elevation, potential insolation, distance to water bodies and the compound topographic index from the SRTM digital elevation model. Preliminary results: areas of lower daily potential insolation, from reduced morning potential insolation in highly elevated terrain, "were found to have the most influence on frost occurrences", and "terrains with subtle slopes and concave landscapes highly contribute to frost occurrences due to cold air pooling". A conference abstract of work in progress, not a peer-reviewed paper.' },
...
const UNVERIFIED = [
  { id: 'D245_STANDARD', cards: ['dry'], text: 'ASABE D245.6/D245.7 could not be verified: the data document is paywalled, and superseded revisions are no longer listed at all, so the older constants cannot be consulted either. The rough-rice constants used here are taken from a thesis reproduction and corroborated against the University of Arkansas EMC table. IRRI\'s own EMC statements run about one percentage point lower, and that gap cannot be closed from either side: IRRI publishes its figures as a table and does not name the equation or the constants behind them.' },
  { id: 'SMITH1992', cards: ['rain'], text: 'CROPWAT effective rainfall methods are not implemented. The USDA-SCS table is verified in FAO Irrigation and Drainage Paper 25, Chapter II (Tables 7 and 8). The FAO/AGLW formula is printed in FAO Paper 46, section 5.1.3, as the second of its four options, Dependable Rain: six tenths of the monthly rainfall less 10 mm below 70 mm, and eight tenths less 24 mm above it. Paper 46 attributes those coefficients to an analysis of arid and sub-humid climates carried out within FAO/AGLW, and neither reproduces nor cites that analysis, so the numbers themselves rest on work this app cannot read. The formula also estimates dependable rainfall at 80 percent probability of exceedance, which Paper 46 offers for design purposes: a dry-year design figure rather than the effective rainfall of the month a farmer has just measured. This app uses the FAO Training Manual 3 formula instead, which breaks at 75 mm.' },
  ...
  { id: 'DEW_NEAR_SATURATION', cards: ['disease'], text: 'The 2 C dew-point depression below which the leaf-wetness card calls dew likely whatever the sky is a design assumption of this app. FAO defines dew by a surface reaching the dew point and prints no such number. The nearest published values are not a single threshold at all: Rao, Gillespie and Schaafsma (1998), following the two-criterion method of Gillespie et al. (1993), fitted 1.8 C to signal the onset of wetting and 2.2 C to signal drying, on maize ears in Ontario, and call those the most satisfactory criteria for that experiment rather than general constants. This app uses one round number lying between them, applies it to rice rather than maize, and does not separate onset from drying.' },
