...
const T = {
  ...
  verdicts: {
    ...
    lw_shorter_than_measured: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. Good news, because that is a short wet spell (compared to the clear, dry-season nights over lowland rice at Los Baños, where dew kept the leaves wet for {rlo} to {rhi} hours; see "Sources" below).', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Magandang balita, dahil maikli lang ang pagkabasa na iyan (kumpara sa maaliwalas at tuyong gabi sa kapatagan ng Los Baños, kung saan pinanatili ng hamog ang mga dahon na basa sa loob ng {rlo} hanggang {rhi} oras; tingnan ang "Sanggunian" sa ibaba).' },
    lw_overlaps_measured: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. That is as long as a dewing night (over lowland rice at Los Baños, clear dry-season nights kept the leaves wet for {rlo} to {rhi} hours; see "Sources" below).', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Kasintagal ito ng isang gabing may hamog (sa kapatagan ng Los Baños, sa maaliwalas at tuyong gabi ay nanatiling basa ang mga dahon sa loob ng {rlo} hanggang {rhi} oras; tingnan ang "Sanggunian" sa ibaba).' },
    lw_longer_than_measured: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. That is a long wet spell, longer than dew alone usually gives (over lowland rice at Los Baños, clear dry-season nights kept the leaves wet for {rlo} to {rhi} hours; see "Sources" below). Rain or fog is the usual reason.', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Mahaba ang pagkabasa na iyan, mas mahaba kaysa sa karaniwang naidudulot ng hamog lamang (sa kapatagan ng Los Baños, sa maaliwalas at tuyong gabi ay nanatiling basa ang mga dahon sa loob ng {rlo} hanggang {rhi} oras; tingnan ang "Sanggunian" sa ibaba). Karaniwang ulan o hamog-ulap ang dahilan.' },
