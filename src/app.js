...
const T = {
  ...
  verdicts: {
    ...
    lw_under_blast: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. Good news, because that is a short wet spell (below the {blo} to {bhi} hours rice blast spores need to germinate, and shorter than the {rlo} to {rhi} hours dew lasted on clear, dry-season nights over lowland rice at Los Baños; see "Sources" below).', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Magandang balita, dahil maikli lang ang pagkabasa na iyan (mas mababa sa {blo} hanggang {bhi} oras na kailangan ng spore ng blast upang tumubo, at mas maikli sa {rlo} hanggang {rhi} oras na nanatiling basa ang mga dahon sa maaliwalas at tuyong gabi sa kapatagan ng Los Baños; tingnan ang "Sanggunian" sa ibaba).' },
    lw_at_blast: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. Somewhat bad news, because that reaches the {blo} to {bhi} hours rice blast spores need to germinate (see "Sources" below). Germination is the first step, not a diseased crop: it still needs spores present, humidity near 100%, and a susceptible variety and stage.', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Medyo hindi magandang balita, dahil umaabot ito sa {blo} hanggang {bhi} oras na kailangan ng spore ng blast upang tumubo (tingnan ang "Sanggunian" sa ibaba). Ang pagtubo ay unang hakbang lamang at hindi pa sakit: kailangan pa rin ng spore, ng halumigmig na malapit sa 100%, at ng baryedad at yugto ng pananim na tablan nito.' },
    lw_dew_night: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. Bad news, because that is as long as a dewing night, well past the {blo} to {bhi} hours rice blast spores need to germinate (over lowland rice at Los Baños, clear dry-season nights kept the leaves wet for {rlo} to {rhi} hours; see "Sources" below).', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Masamang balita, dahil kasintagal ito ng isang gabing may hamog at lampas na sa {blo} hanggang {bhi} oras na kailangan ng spore ng blast upang tumubo (sa kapatagan ng Los Baños, sa maaliwalas at tuyong gabi ay nanatiling basa ang mga dahon sa loob ng {rlo} hanggang {rhi} oras; tingnan ang "Sanggunian" sa ibaba).' },
    lw_beyond_dew: { en: 'The PAGASA Farm Weather Forecast gives {lo} to {hi} hours of leaf wetness for your forecast area. Bad news, because that is a long wet spell, longer than dew alone usually gives and well past the {blo} to {bhi} hours rice blast spores need to germinate (over lowland rice at Los Baños, clear dry-season nights kept the leaves wet for {rlo} to {rhi} hours; see "Sources" below). Rain or fog is the usual reason.', fil: 'Ang PAGASA Farm Weather Forecast ay nagbibigay ng {lo} hanggang {hi} oras na basang dahon para sa iyong lugar sa kanilang ulat-panahon. Masamang balita, dahil mahaba ang pagkabasa na iyan, mas mahaba kaysa sa karaniwang naidudulot ng hamog lamang at lampas na sa {blo} hanggang {bhi} oras na kailangan ng spore ng blast upang tumubo (sa kapatagan ng Los Baños, sa maaliwalas at tuyong gabi ay nanatiling basa ang mga dahon sa loob ng {rlo} hanggang {rhi} oras; tingnan ang "Sanggunian" sa ibaba). Karaniwang ulan o hamog-ulap ang dahilan.' },
...
CARDS.disease = function (root) {
  ...
  function run() {
    ...
    if (inp.lwLo != null || inp.lwHi != null) {
      ...
      lwPanel = result({ level: 'info', verdict: t(T.verdicts[lwr.code], { lo: fmt(inp.lwLo, 1), hi: fmt(inp.lwHi, 1), blo: A.BLAST_WET.germLoH, bhi: A.BLAST_WET.germHiH, rlo: fmt(A.DEW_RICE_LB.nightLoH, 1), rhi: fmt(A.DEW_RICE_LB.nightHiH, 1) }),
        lines: lwr.straddlesBlast ? [[bi({ en: 'Your area is split', fil: 'Hati ang inyong lugar' }),
          bi({ en: 'The drier parts stay under ' + A.BLAST_WET.germLoH + ' h, but the wetter parts reach ' + fmt(inp.lwHi, 1) + ' h. Which one your own field is, only your own field can say.',
            fil: 'Ang mas tuyong bahagi ay wala pang ' + A.BLAST_WET.germLoH + ' oras, ngunit ang mas basang bahagi ay umaabot sa ' + fmt(inp.lwHi, 1) + ' oras. Kung alin doon ang bukid ninyo, ang bukid ninyo lamang ang makapagsasabi.' })]] : null,
