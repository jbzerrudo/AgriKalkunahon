...
**Version DOI** every release gets its own: v0.5.1 is
[10.5281/zenodo.22748252](https://doi.org/10.5281/zenodo.22748252), v0.4.0 is
[10.5281/zenodo.22735323](https://doi.org/10.5281/zenodo.22735323), v0.3.1 is
...
a reader gets the exact build you used. (v0.3.0 and v0.5.0 were both published while Zenodo was down and
never archived; v0.3.1 and v0.5.1 are the same apps re-tagged.)

> Zerrudo, J. (2026). *AgriKalkunahon: an offline farm-decision calculator for the Philippines*
> (version 0.5.1). Zenodo. https://doi.org/10.5281/zenodo.22748252
